...
public class ShopManagementGUI {
    ...
    static void manageProducts() {
        ...
        switch (choice) {
            case 0: // Add Product
            // This prompts the user to enter the product name, price, and stock to add a new product to the inventory
    ...
    static void recordSale() {
        ...
        try {
            ...
            if (quantity > productToSell.getStock()) {
                // This displays a message if there is not enough stock available for the selected product
    ...
    static void generateReport() {
        ...
        sb.append("\nInventory Report:\n");
        // This loops through the inventory products and appends the details to the report
        for (Product p : inventory.products) {
